        ...
        switch (this.state.orderBy) {
            case "name":
                ...
                return this.state.components.toSorted((a, b) => {
                    if (a.type.name === "FolderRow" && b.type.name === "DocumentRow") {
                        return (-order);
                    } else if (a.type.name === "DocumentRow" && b.type.name === "FolderRow") {
                        return order;
                    } else {
            ...
            case "details":
                return this.state.components.toSorted((a, b) => {
                    if (a.type.name === "FolderRow" && b.type.name === "DocumentRow") {
                        ...
                        const detailsA = a.type.name === "FolderRow" ? a.props.info?.["contents"] : a.props.info?.["pages"];
                        const detailsB = b.type.name === "FolderRow" ? b.props.info?.["contents"] : b.props.info?.["pages"];
